...
public class ClaseFecha {
    ...
    public void tiempoTranscurrido(String fecha1, String fecha2){
        try {
            ...
            //Date primeraFecha1 = new Date();
            //Date segundaFecha2 = new Date();
            ...
            //toInstant(); LocalDate primeraFecha1 = instant.atZone(defaultZoneld).toLocalDate();
            //toInstant(); LocalDate segundaFecha1 = instant.atZone(defaultZoneld).toLocalDate();
